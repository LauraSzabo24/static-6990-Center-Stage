...
@TeleOp
public class RedTetrisShow extends LinearOpMode {
    /* TO-DO
    ...
    public void moveToPose(double[] position, double zOffset)
    {
        ...
        //Vector2d positionVector = new Vector2d(40.3, -35); //40.3 -45 //-position[0]
        Vector2d positionVector = new Vector2d(18.3, -37); //sec pos
        if(counter==1)
        {
            positionVector = new Vector2d(35.3, -37); //first pos
        }
