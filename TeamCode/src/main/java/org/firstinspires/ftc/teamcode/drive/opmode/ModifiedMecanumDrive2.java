 ...
 */
@Config
public class ModifiedMecanumDrive2 extends MecanumDrive {
    ...
    public ModifiedMecanumDrive2(HardwareMap hardwareMap) {
    ...
    public void superSecretAddition(Mailbox mail)
    {
        mail.setAutoEnd(this.getPoseEstimate());
    }
